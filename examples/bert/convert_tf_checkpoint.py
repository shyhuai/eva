...
BertForPretraining = modeling.BertForPreTraining
...
def parse_arguments():
    ...
    parser.add_argument('--bert_config_path',
                        type=str,
                        default="/home/yanxindong/models/official/nlp/Bert/checkpoints/convert_to_ms/tf_ckpt/bert_config.json",
