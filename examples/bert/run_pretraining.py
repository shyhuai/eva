...
import optimizers.deva as deva
...
def parse_arguments():
    ...
    parser.add_argument('--disable_progress_bar', default=True, action='store_true',
    ...
    parser.add_argument('--beta1', type=float, default=0.1,
                        help='Alpha value for grad accumulation (default: 0.1 for Deva)')
...
def prepare_dataset(args, checkpoint):
    ...
    loader = torch.utils.data.DataLoader(dataset, sampler=sampler,
                                         batch_size=args.local_batch_size, num_workers=8, pin_memory=True)
    ...
    while True:
        ...
        for batch in train_iter:
            ...
            if sync_grads:
                ...
                if is_main_process():
                    if args.disable_progress_bar and global_steps % 10 == 0:
                        logger.info("step: {}, epoch: {}, average_loss: {}, step_loss: {}, learning_rate: {}".format(
            ...
            if (global_steps >= args.max_steps or timeout_sent or
                ...
                if is_main_process() and not args.skip_checkpoint:
                    ...
                    output_save_file = os.path.join(
                        ...
                        "{}_ckpt_{}_{}.pt".format(args.optimizer, global_steps + args.previous_phase_end_step, args.max_steps))
                    model_dict = {
